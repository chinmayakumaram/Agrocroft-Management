...
<body>
    ...
    <header>
        <h1>Welcome to the Online Farmer Crop Market</h1>
    </header>
    <div class="button">
    ...
    <main>
        ...
        <div class="products-container">
            ...
            $stmt = $pdo->prepare("SELECT * FROM sell");
            $stmt->execute();
            ...
            foreach ($products as $product) {
                ...
                <img class="product-image" src="images/' . strtolower(str_replace(' ', '_', $product['crop_name'])) . '.jpg" alt="' . htmlspecialchars($product['crop_name']) . '">
                    <h3>' . htmlspecialchars($product['crop_name']) . '</h3>
                    <p>Price: $' . number_format($product['price'], 2) . '</p>
                    <p>Phone Number:' . htmlspecialchars($product['phone']).'</p> 
                    <form method="POST">
                        <input type="hidden" name="product_id" value="' . $product['id'] . '">
                        <input type="hidden" name="product_name" value="' . $product['crop_name'] . '">
